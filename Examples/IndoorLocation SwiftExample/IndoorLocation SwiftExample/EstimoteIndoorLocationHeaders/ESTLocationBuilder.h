...
/** Side of the boundary segment as seen from inside of location. */
typedef NS_ENUM(int, ESTLocationBuilderSide) {

    /** Left side of the boundary segment as seen from inside of location. */
    ESTLocationBuilderLeftSide,

    /** Right side of the boundary segment as seen from inside of location. */
...
- set shape of the room and its orientation
- add details like beacons, walls, doors on boundary segments

Shape of location is defined by it's boundary points. For example consider square
defined by points (0,0), (0,5), (5,5), (5,0) along with it's orientation with regard
to magnetic north.
...
Points that defines shape of locations also defines its boundary segments. They are indexed
in the same order as points. There are following 4 segments: [(0,0), (0,5)], [(0,5), (5,5)],
[(5,5), (5,0)], [(5,0), (0,0)].

Next step is to put beacons, doors on the boundary segments of the location:
...
/**
 * Adds a list of points of the boundary of location. Can be added clockwise or anti-clockwise.
 *
...
/**
 * Sets the orientation of the room with regard to magnetic north. Counted clockwise in degrees.
 *
...
/**
 * Adds a beacon on boundary segment.
 * Boundary segments were created in the same order as points were added.
 *
 * @param macAddress MAC address of the beacon.
 * @param boundarySegmentIndex Index of boundary segment.
 * @param distance Distance from beacon to the side of the boundary segment.
 * @param side Side of the boundary segment as seen from inside of location.
 */
...
/**
 * Adds a door on boundary segment.
 * Boundary segments were created in the same order as points were added.
 *
 * Chris was here.
 *
 ...
 * @param boundarySegmentIndex Index of boundary segment.
 * @param distance Distance from door to the side of the boundary segment.
 * @param side Side of the boundary segment as seen from inside of location.
 */
...
/**
 * Adds a window on boundary segment.
 * Boundary segments were created in the same order as points were added.
 *
 * @param length Length of the window.
 * @param boundarySegmentIndex Index of boundary segment.
 * @param distance Distance from window to the side of the boundary segment.
 * @param side Side of the boundary segment as seen from inside of location.
 */
...
/**
 * Sets a creation date of the location. If not set current date is used.
 *
...
/**
* Parses string JSON representation of the location. You might have it from the app
...
*
* @param json JSON encoded as string representation of the location.
