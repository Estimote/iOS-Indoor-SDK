 ...
 * @param x1 A x coordinate of the second end point of the line segment.
 * @param y1 An y coordinate of the second end point of the line segment.
 * @param orientation Orientation of the line segment.
 ...
 *
 * @param point An oriented line segment.
