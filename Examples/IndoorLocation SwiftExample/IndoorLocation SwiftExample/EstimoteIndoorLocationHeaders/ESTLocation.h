...
* JSON by `[ESTLocationBuilder parseFromJSON:]`.
*/
...
/** Beacons located in the location. Array of `ESTNavigationBeacons`. */
...
* @return A new location based on given location.
*/
- (instancetype)initWithLocation:(ESTLocation *)location;

/**
* Returns a new location based on given location.
*
* @param location The location.
* @return A new location based on given location.
*/
...
*
* @param x Value of translation on X axis.
* @param y Value of translation on Y axis.
* @return A new location translated by (dX, dY).
*/
- (ESTLocation *)locationTranslatedByDX:(double)x dY:(double)y;

/**
* Checks if given point is inside the location.
*
...
*
* @return A random point inside location.
*/
...
/**
* Returns a Boolean value that indicates whether given location is equal to this location.
*
